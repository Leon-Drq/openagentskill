...
const packsByLocale: Record<MarketLocale, Record<string, PackCopy>> = {
  zh: {
    ...
    'ai-video-creator-agent-pack': { title: 'AI 视频创作', description: '将选题、策划、配音、剪辑、字幕、封面和复盘串成可审查视频工作流的技能包。' },
  ...
  ja: {
    ...
    'ai-video-creator-agent-pack': { title: 'AI 動画制作', description: '企画、構成、ナレーション、編集、字幕、カバー、振り返りを確認可能な動画ワークフローへつなぐ Skill Pack。' },
  ...
  ko: {
    ...
    'ai-video-creator-agent-pack': { title: 'AI 영상 제작', description: '주제 선정, 기획, 내레이션, 편집, 자막, 커버, 회고를 검토 가능한 영상 워크플로로 연결하는 Skill Pack입니다.' },
  ...
  es: {
    ...
    'ai-video-creator-agent-pack': { title: 'Creador de video con IA', description: 'Un pack revisable que conecta tema, planificación, narración, edición, subtítulos, portada y retrospectiva.' },
  ...
  de: {
    ...
    'ai-video-creator-agent-pack': { title: 'KI-Video-Creator', description: 'Ein überprüfbares Pack für Thema, Planung, Vertonung, Schnitt, Untertitel, Cover und Retrospektive.' },
  ...
  fr: {
    ...
    'ai-video-creator-agent-pack': { title: 'Créateur vidéo IA', description: 'Un pack vérifiable qui relie sujet, plan, narration, montage, sous-titres, couverture et rétrospective.' },
  ...
  id: {
    ...
    'ai-video-creator-agent-pack': { title: 'Kreator video AI', description: 'Pack yang dapat ditinjau untuk topik, perencanaan, narasi, editing, subtitle, sampul, dan retrospektif.' },
