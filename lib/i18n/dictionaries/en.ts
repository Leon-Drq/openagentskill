export default {
  ...
  nav: {
    ...
    integrationKit: 'Integration Kit',
  ...
  hero: {
    ...
    orDescribeTask: 'Describe a task',
...
Built by everyone (and every Agent), for everyone.`,
  ...
  submitPage: {
    ...
    form: {
      ...
      repositoryRequirements: 'At least {minStars} GitHub stars are required. Every submission receives a static security scan, AI quality review, and publishing gate check.',
      category: 'Category',
      ...
      repositoryRequired: 'Please provide a GitHub repository URL',
      minimumStarsError: 'This repository has {stars} stars and does not meet the minimum requirement of {minStars} stars.',
      missingReadme: 'This repository does not have a README. Add one and try again.',
      submissionFailed: 'Submission failed. Please try again later.',
      skillAlreadyExists: 'This skill is already listed on OpenAgentSkill.',
      saveFailed: 'The skill passed review, but could not be saved. Please try again later.',
    ...
    result: {
      approved: {
        ...
        badgeEyebrow: 'README badge',
        badgeDescription: 'Add this badge to the repository README after the listing is live.',
      },
      rejected: {
    ...
    guidelines: {
      ...
      items: [
        ...
        'Static security analysis and AI scoring run before publishing',
        'Only skills that pass the automatic gate are published immediately; risky submissions require review',
      ],
    },
    afterApproval: {
      eyebrow: 'After approval',
      title: 'Add the OpenAgentSkill badge to your README',
      description: 'Approved skills get a public listing, install handoff API, and badge endpoint. Add the badge to your GitHub README so users and agents can verify the listing from the repository.',
      steps: [
        'Submit a GitHub repository with a clear README and install path.',
        'Claim the listing after approval to show verified ownership.',
        'Add the badge and link back to the OpenAgentSkill skill page.',
      ],
    },
  },
