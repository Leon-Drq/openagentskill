...
export const SEARCH_ENTRY_PAGES = {
  ...
  'ai-agent-skills': {
    ...
    cards: [
      {
        title: 'Codex',
        body: 'Find skills for codebase analysis, refactors, tests, migrations, and repository workflows.',
        href: '/agents/codex',
        label: 'Agent',
      },
      {
        title: 'Claude Code',
        body: 'Discover reusable file, repository, browser, and documentation workflows for Claude Code.',
        href: '/agents/claude-code',
        label: 'Agent',
      },
      {
        title: 'Cursor',
        body: 'Route coding tasks to installable skills, templates, and verified repositories.',
        href: '/agents/cursor',
        label: 'Agent',
      },
      {
        title: 'Agent runtimes',
        body: 'Use structured APIs and manifests instead of one-off search prompts.',
        href: '/api-docs',
        label: 'API',
      },
    ],
