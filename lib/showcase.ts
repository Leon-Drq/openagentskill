...
// @ts-expect-error Direct Node regression tests require the TypeScript extension.
import { type ShowcaseCategory, showcaseText, getShowcaseImageSrc, ORIGINAL_SHOWCASE_UPDATED_AT, SHOWCASE_CATEGORIES, getShowcaseTags, getShowcaseCreator, getShowcaseSkill, type ShowcaseCase } from './showcase-shared.ts'
// @ts-expect-error Direct Node regression tests require the TypeScript extension.
export * from './showcase-shared.ts'
