...
const DOMAIN_QUERY_GROUPS: Array<{
  ...
  {
    key: 'presentations',
    label: 'Presentation, slide deck, and PPT agent skills',
    description: 'Editable PPTX generation, HTML slide decks, visual presentation systems, deck templates, speaker notes, and content-to-presentation workflows.',
    queries: [
      {
        q: 'repo:hugohe3/ppt-master',
        category: 'presentation-generation',
        tags: ['ppt', 'pptx', 'presentation', 'slides', 'agent-skill'],
        frameworks: ['PowerPoint', 'Presentation'],
      },
      {
        q: 'repo:zarazhangrui/frontend-slides',
        category: 'presentation-generation',
        tags: ['html-slides', 'presentation', 'design', 'agent-skill'],
        frameworks: ['HTML', 'Presentation'],
      },
      {
        q: 'repo:alchaincyf/huashu-design',
        category: 'presentation-design',
        tags: ['presentation', 'design', 'prototype', 'animation', 'agent-skill'],
        frameworks: ['HTML', 'Presentation'],
      },
      {
        q: 'repo:op7418/guizang-ppt-skill',
        category: 'presentation-generation',
        tags: ['ppt', 'slides', 'html-slides', 'agent-skill'],
        frameworks: ['HTML', 'Presentation'],
      },
      {
        q: 'repo:lewislulu/html-ppt-skill',
        category: 'presentation-generation',
        tags: ['html-ppt', 'presentation', 'themes', 'animations', 'agent-skill'],
        frameworks: ['HTML', 'Presentation'],
      },
      {
        q: 'repo:JimLiu/baoyu-skills',
        category: 'presentation-generation',
        tags: ['ppt', 'visual-materials', 'presentation', 'agent-skill'],
        frameworks: ['Presentation'],
      },
      {
        q: 'repo:joeseesun/qiaomu-anything-to-notebooklm',
        category: 'presentation-generation',
        tags: ['content-to-ppt', 'notebooklm', 'pdf', 'web', 'agent-skill'],
        frameworks: ['NotebookLM', 'Presentation'],
      },
      {
        q: '"ppt" "agent skill"',
        category: 'presentation-generation',
        tags: ['ppt', 'presentation', 'agent-skill'],
        frameworks: ['Presentation'],
        sort: 'updated',
      },
      {
        q: '"pptx" "Claude Code" "skill"',
        category: 'presentation-generation',
        tags: ['pptx', 'claude-code', 'presentation'],
        frameworks: ['Claude Code', 'PowerPoint'],
        sort: 'updated',
      },
      {
        q: '"presentation" "agent skill"',
        category: 'presentation-generation',
        tags: ['presentation', 'slides', 'agent-skill'],
        frameworks: ['Presentation'],
        sort: 'updated',
      },
      {
        q: '"slide deck" "agent"',
        category: 'presentation-generation',
        tags: ['slide-deck', 'presentation', 'agent'],
        frameworks: ['Presentation'],
        sort: 'updated',
      },
      {
        q: 'topic:presentation topic:agent-skills',
        category: 'presentation-generation',
        tags: ['presentation', 'agent-skills'],
        frameworks: ['Presentation'],
        sort: 'updated',
      },
      {
