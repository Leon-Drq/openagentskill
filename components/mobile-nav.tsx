  ...
  return (
    <div className="xl:hidden">
      <button
        ...
        className="-mr-2 p-2 text-secondary transition-colors hover:text-foreground"
            ...
            <ul className="space-y-1">
              <li>
                <a
                  ...
                  className="flex items-center justify-center gap-3 rounded-[8px] bg-[#006b4f] px-4 py-3 text-base font-semibold text-white transition-opacity hover:opacity-90"
                >
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-3 border border-border px-4 py-3 text-base text-secondary transition-colors hover:border-foreground hover:text-foreground"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
