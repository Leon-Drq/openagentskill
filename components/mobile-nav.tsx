      ...
      {isOpen && (
        ...
        >
          ...
          <nav className="px-6 py-8">
            <ul className="space-y-1">
              <li>
                <Link
                  ...
                  style={{ 
                    color: pathname === '/skills' ? '#1A1A1A' : '#666666',
                    fontWeight: pathname === '/skills' ? 500 : 400,
                  }}
                >
                  {t.nav.skills}
                </Link>
              ...
              <li>
                <Link
                  ...
                  className="block py-4 text-xl"
                  style={{ 
                    color: pathname === '/submit' ? '#1A1A1A' : '#666666',
                    fontWeight: pathname === '/submit' ? 500 : 400,
                  }}
                >
                  {t.nav.submit}
                </Link>
              ...
              <li>
                <Link
                  ...
                  className="block py-4 text-xl"
                  style={{ 
                    color: pathname === '/docs' ? '#1A1A1A' : '#666666',
              ...
              <li>
                <Link
                  ...
                  className="block py-4 text-xl"
                  style={{ 
                    color: pathname === '/activity' ? '#1A1A1A' : '#666666',
                    fontWeight: pathname === '/activity' ? 500 : 400,
                  }}
                >
                  {t.nav.activity}
                </Link>
            ...
            {/* Divider */}
            <div className="my-8" style={{ borderTop: '1px solid #E8E8E8' }} />
