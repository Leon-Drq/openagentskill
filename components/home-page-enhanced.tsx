...
interface HomePageEnhancedProps {
  ...
  stats: {
    ...
    discoveredProjects: number | null
    validatedSkills: number | null
...
const HOME_COPY: Record<Locale, {
  ...
  en: {
    ...
    stats: ['Installable skills', 'Verified installs', 'Agent outcomes', 'Skills with evidence'],
  ...
  zh: {
    ...
    githubCta: '查看 GitHub',
    registryApi: '注册表 API',
    stats: ['可安装技能', '已验证安装', 'Agent 运行结果', '有实证的技能'],
  ...
  ja: {
    ...
    registryApi: 'Registry API',
    stats: ['インストール可能な Skill', '検証済みインストール', 'Agent 実行結果', '実証済み Skill'],
    taskEyebrow: 'Agent resolve',
  ...
  ko: {
    ...
    githubCta: 'GitHub 보기',
    registryApi: 'Registry API',
    stats: ['설치 가능한 Skill', '검증된 설치', 'Agent 실행 결과', '증거가 있는 Skill'],
    taskEyebrow: 'Agent resolve',
  ...
  es: {
    ...
    registryApi: 'Registry API',
    stats: ['Skills instalables', 'Instalaciones verificadas', 'Resultados agent', 'Skills con evidencia'],
    taskEyebrow: 'Agent resolve',
  ...
  de: {
    ...
    registryApi: 'Registry API',
    stats: ['Installierbare Skills', 'Verifizierte Installationen', 'Agent-Ergebnisse', 'Skills mit Evidenz'],
    taskEyebrow: 'Agent resolve',
  ...
  fr: {
    ...
    registryApi: 'Registry API',
    stats: ['Skills installables', 'Installations verifiees', 'Resultats agent', 'Skills avec preuves'],
    taskEyebrow: 'Agent resolve',
  ...
  id: {
    heroEyebrow: 'SKILL LAYER · AGENT REGISTRY · AUTO INSTALLS',
    heroLine1: 'Lapisan skill',
    heroLine2Prefix: 'untuk ',
    heroAccent: 'AI agents.',
    heroSubtitle: 'Biarkan AI agent Anda menemukan, membandingkan, dan memasang skill yang tepat secara otomatis.',
    primaryCta: 'Cari skill untuk agent saya',
    githubCta: 'Lihat di GitHub',
    registryApi: 'Registry API',
    stats: ['Skill siap dipasang', 'Instalasi terverifikasi', 'Hasil agent', 'Skill dengan bukti'],
    taskEyebrow: 'Agent resolve',
    ...
    taskPlaceholder: 'Ambil situs web dan ekstrak data terstruktur...',
    demoTask: 'Coba tugas demo',
    selectedPlan: 'Rencana skill terpilih',
    reviewing: 'Memeriksa sinyal kepercayaan...',
    startWith: 'Mulai dengan',
    noReliableMatch: 'Belum ada kecocokan yang andal',
    searchedPrefix: 'Mencari',
    searchedSuffix: 'skill',
    selected: 'Terpilih',
    fit: 'kecocokan',
    safety: 'Keamanan',
    audit: 'Audit',
    target: 'Target',
    copied: 'Tersalin',
    copyInstall: 'Salin pemasangan',
    installApi: 'Install API',
    details: 'Detail',
    trustSignals: [
      ['Kesesuaian tugas', '96/100', 'Direkomendasikan untuk alur ekstraksi web'],
      ['Pemeliharaan', 'Aktif', 'Stars, kebaruan, metadata, dan kesehatan repositori'],
      ['Tinjauan pemasangan', 'Siap', 'Langkah aman sebelum agent dijalankan'],
    ],
    whyEyebrow: 'Mengapa OpenAgentSkill',
    whyTitle: 'Jangan kirim agents ke direktori acak.',
    whyIntro: 'Registry skill hanya berguna ketika agent dapat mempercayainya. OpenAgentSkill mengubah proyek GitHub yang tersebar menjadi kemampuan yang dapat diperingkat, diaudit, dan dipasang.',
    whyPoints: [
      ['01', 'Dari tugas ke skill', 'Agents mulai dari niat, bukan halaman kategori. Registry memetakan pekerjaan ke satu skill pilihan, alternatif, dan alasan kecocokan.'],
      ['02', 'Keamanan sebelum pemasangan', 'Stars, kebaruan, skor kualitas, petunjuk izin, risiko, dan kesiapan berada di samping perintah yang akan dijalankan agent.'],
      ['03', 'Manusia menjelajah, agents memakai API', 'Manusia dapat menelusuri indeks; agents dapat memanggil registry yang sama melalui endpoint resolve, recommendation, dan skill.'],
    ],
    responseEyebrow: 'Respons registry',
    responseTitle: 'Satu panggilan, jalur pemasangan berperingkat.',
    architectureEyebrow: 'Arsitektur',
    architectureTitle: 'Empat lapisan antara niat dan pemasangan.',
    architectureIntro: 'OpenAgentSkill bukan daftar statis lain. Ini adalah loop registry yang dapat dipanggil agent sebelum menulis file, membuka browser, atau memasang kode pihak ketiga.',
    compareEyebrow: 'Perbandingan',
    compareTitle: 'Perbedaan OpenAgentSkill dari platform skill lain.',
    compareIntro: 'Pertaruhannya sederhana: direktori biasa dibuat untuk manusia. OpenAgentSkill dibuat agar AI agent dapat menemukan, membandingkan, dan memasang skill yang tepat secara otomatis.',
  },
}
...
const DISCOVERY_COPY: Record<string, {
  ...
  en: {
    ...
    discoveredProjects: 'Projects found',
    validatedSkills: 'Validated skills',
    installableSkills: 'Installable',
  },
  zh: {
    liveApi: '实时 Agent API',
    sourceRefresh: '数据刷新',
    machineContract: '机器接口',
    discoveredProjects: '已发现项目',
    validatedSkills: '已验证技能',
    installableSkills: '可安装',
  },
}
...
export function HomePageEnhanced({ initialLocale, stats, featuredSkills, rankingGeneratedAt }: HomePageEnhancedProps) {
  ...
  const discoveredProjectsLabel = stats.coverageExact && stats.discoveredProjects !== null
    ? stats.discoveredProjects.toLocaleString()
    : 'Live'
  const validatedSkillsLabel = stats.coverageExact && stats.validatedSkills !== null
          ...
          <div className="grid min-w-0 gap-8 md:grid-cols-12 md:items-end">
            ...
            <div className="min-w-0 md:col-span-5">
              <div className="grid overflow-hidden rounded-[10px] border border-[#d8d2c6] bg-[#fffdf8] sm:grid-cols-3">
                {[
                  [discoveryCopy.discoveredProjects, discoveredProjectsLabel],
                  [discoveryCopy.validatedSkills, validatedSkillsLabel],
                  [discoveryCopy.installableSkills, totalSkillsLabel],
                ].map(([label, value]) => (
