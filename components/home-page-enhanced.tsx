        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 sm:gap-5">
            ...
            <div className="hidden md:flex items-center gap-5">
              ...
              <Link href="/docs" className="text-sm text-secondary hover:text-foreground transition-colors">
                {t.nav.docs}
              </Link>
              <Link href="/activity" className="text-sm text-secondary hover:text-foreground transition-colors">
                {t.nav.activity}
              </Link>
            </div>
            <a
