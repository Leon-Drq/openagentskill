...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    candidate_pipeline: {
      ...
      public_coverage_endpoint: '/api/registry/stats',
    ...
    seo_growth: {
      ...
      ranking_surfaces: [
        ...
        '/tasks/{task}',
        '/api/agent/resolve',
        '/api/agent/resolve?format=lockfile',
        '/api/agent/receipt',
        '/skill-packs',
        '/api/agent/packs',
      ],
    ...
    agent_outcome_loop: {
      ...
      resolve_lockfile: '/api/agent/resolve?task={task}&agent={agent}&format=lockfile',
      workflow_packs: '/api/agent/packs',
      workflow_pack_install_plan: '/api/agent/packs/{slug}?limit=6',
      ...
      recommended_agent_flow: [
        ...
        'Use /api/agent/resolve?format=lockfile when you need a compact stable execution object.',
        'Use /api/agent/packs/{slug} when the task is a multi-step workflow rather than one skill lookup.',
    ...
    endpoints: {
      ...
      public_resolve_lockfile: '/api/agent/resolve?task={task}&agent={agent}&format=lockfile',
      public_skill_packs: '/api/agent/packs',
      public_skill_pack_detail: '/api/agent/packs/{slug}?limit=6',
