...
export const metadata: Metadata = {
  title: 'Best AI Agent Skills by Use Case',
  description:
    'Browse the best AI agent skills for web scraping, coding agents, RAG, browser automation, data analysis, GitHub automation, and other production workflows.',
  alternates: {
    canonical: 'https://www.openagentskill.com/best',
  },
  openGraph: {
    title: 'Best AI Agent Skills by Use Case - OpenAgentSkill',
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
        <section className="border-b border-border pb-10">
          <p className="mb-4 text-xs uppercase tracking-widest text-secondary">Best agent skills</p>
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
            <div>
              <h1 className="font-display text-4xl font-bold leading-tight text-balance md:text-6xl">
                Best AI agent skills for real workflows.
              </h1>
        ...
        <section className="grid gap-4 border-b border-border py-10 lg:grid-cols-3">
          {FEATURED_BEST_PAGES.slice(0, 3).map((page) => {
            ...
            return (
              ...
              >
                <div>
                  <p className="mb-3 text-xs uppercase tracking-widest text-secondary">{page.eyebrow}</p>
        ...
        <section className="py-10">
          <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
            <div>
              <p className="mb-3 text-xs uppercase tracking-widest text-secondary">All best-of lists</p>
          ...
          <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
            {BEST_SKILL_PAGES.map((page) => {
              ...
              return (
                ...
                >
                  <p className="text-xs uppercase tracking-widest text-secondary">{page.eyebrow}</p>
